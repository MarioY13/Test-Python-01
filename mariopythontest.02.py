...
if __name__ == "__main__":
    ...
    try:
        # Crear productos con las categorías y cantidades indicadas
        producto1 = Producto("Ordenador", "Electrónica", 1500, 100)
        producto2 = Producto("Discos duros", "Almacenamiento", 80, 200)
        producto3 = Producto("Placas bases", "Componentes", 200, 125)
        producto4 = Producto("Memoria RAM", "Componentes", 120, 300)
        ...
        # Buscar producto
        producto_buscado = inventario.buscar_producto("Ordenador")
        if producto_buscado:
            print("\nProducto encontrado:", producto_buscado)

        # Actualizar producto
        inventario.actualizar_producto("Ordenador", nuevo_precio=1400, nueva_cantidad=90)

        # Eliminar producto
        inventario.eliminar_producto("Discos duros")

        # Mostrar inventario después de actualización y eliminación
